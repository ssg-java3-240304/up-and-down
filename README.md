...
> 박수빈
- 프로젝트를 진행하면서 배우지 못한 부분도 공부하고 배운 부분을 복습했던 시간들이 힘들었지만 많은 도움이 된 것 같아 기억에 남을 것 같습니다.
부족한 부분이 많아 생각한만큼 일을 진행하지 못했지만 팀원들의 도움과 응원 덕분에 프로젝트를 잘 마무리했습니다. 중간 중간 충돌도 있었고 풀리지 않는 부분도 있었지만 하나씩 천천히 진행하며 해결을 시도했습니다. 해결했을 땐 뿌듯한 감정도 있었지만 같은 문제가 발생했을 때 다시 헤메이지 않도록 기록하는 습관을 연습할 수 있어서 좋았습니다.

> 전현선
- 지금까지 진행했던 미니 프로젝트와 달리, 이번 파이널 프로젝트는 기획부터 배포까지 모든 과정을 팀원들과 함께 결정하고 작업하면서 많은 것을 배울 수 있었습니다. 특히, 강사님과 멘토님들의 피드백을 통해 부족한 부분을 수정하며 프로젝트를 더욱 발전시킬 수 있었습니다. 많은 시행착오가 있었지만, 그 과정에서 다양한 문제를 해결하며 성장할 수 있었습니다. 특히, 팀원 수가 다른 팀들에 비해 부족한 상황에서 시작했지만, 서로의 강점을 살리며 협력하여 프로젝트를 성공적으로 마칠 수 있었습니다. 새로운 기능으로는 STOMP를 활용한 채팅 기능을 구현했으며, 이를 통해 실시간 통신 기술에 대한 이해를 넓힐 수 있었습니다. 이번 프로젝트를 통해 팀워크의 중요성을 다시 한번 깨달았고, 부족한 인원 속에서도 좋은 팀원들과 함께 많은 것을 배우며 성장할 수 있었습니다. 앞으로도 이러한 경험을 바탕으로 더욱 효율적이고 협력적인 프로젝트를 진행할 수 있을 것 같습니다.
