...
public class GoogleSNSService {
    ...
    public String reqSnsApi() {
        ...
        String redirectURI = "http://localhost:8080/member/google_login";
//        String redirectURI = "http://211.188.54.220:8080/member/google_login";
    ...
    public String getGoogleAccessToken(String code) {
        URI uri = UriComponentsBuilder.fromUriString("https://oauth2.googleapis.com/token")
                ...
                .queryParam("redirect_uri", "http://localhost:8080/member/google_login")
//                .queryParam("redirect_uri", "http://211.188.54.220:8080/member/google_login")
                .build()
                .toUri();
