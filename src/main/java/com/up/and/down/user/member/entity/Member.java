...
public class Member extends User {
    ...
    public Member(Long id, String name, String userId, String password, String phone, String email, Set<Authority> authorities, String nickname, com.up.and.down.user.member.entity.Gender gender, LocalDate birth, Marketing marketing) {
